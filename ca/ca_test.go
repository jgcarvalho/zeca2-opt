...
func TestRun(t *testing.T) {
	r := rule.Read("/home/jgcarvalho/gocode/src/github.com/jgcarvalho/zeca2-opt/AAA.probs")
	// fmt.Println(r)
	conf := ca.Config{
		InitState:   []string{"###", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "A??", "###"},
		EndState:    []string{"###", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Aa0", "Ab0", "###"},
		Steps:       1000,
		IgnoreSteps: 1,
	}
